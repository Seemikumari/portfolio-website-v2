  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between px-3 md:px-24 py-3">
        <div>
          <Link to="/">
            <h1 className="text-2xl text-primary font-lobster">Seemi Kumari</h1>
          </Link>
        </div>
        <div>
          <ul className="lg:flex items-center hidden">
            ...
            <a
              ...
              href="https://docs.google.com/document/d/13dGidsc8cYsxk9N7bbu2OtoewSmP7BBO/edit?usp=sharing&ouid=118062792479235355738&rtpof=true&sd=true"
              target="blank"
            >
              <PrimaryBtn>
                <span>Resume</span>
            ...
            >
              ...
              <div className="text-center">
                <p className="text-neutral">
                  &copy; Copyright 2024, Seemi Kumari. All Rights Reserved
                </p>
              </div>
            </Drawer>
          </div>
